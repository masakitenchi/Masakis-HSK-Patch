...
public class SpecialThingFilterWorker_MealSimple : SpecialThingFilterWorker
{
    ...
    public override bool AlwaysMatches(ThingDef def) => def.thingCategories.Contains(ThingCategoryDefOf.Foods) && def.ingestible?.preferability == FoodPreferability.MealSimple;
...
public class SpecialThingFilterWorker_MealFine : SpecialThingFilterWorker
{
    ...
    public override bool AlwaysMatches(ThingDef def) => def.thingCategories.Contains(ThingCategoryDefOf.Foods) && def.ingestible?.preferability == FoodPreferability.MealFine;
    public override bool Matches(Thing t) => CanEverMatch(t.def) && AlwaysMatches(t.def);
}
...
public class SpecialThingFilterWorker_MealLavish : SpecialThingFilterWorker
{
    ...
    public override bool AlwaysMatches(ThingDef def) => def.thingCategories.Contains(ThingCategoryDefOf.Foods) && def.ingestible?.preferability == FoodPreferability.MealLavish;
    public override bool Matches(Thing t) => CanEverMatch(t.def) && AlwaysMatches(t.def);
}
...
public class SpecialThingFilterWorker_PrimeMeat : SpecialThingFilterWorker
{
    ...
    public override bool Matches(Thing t) => t is Corpse corpse && corpse.InnerPawn.def.race.meatDef is ThingDef meat && meat.defName == "Meat_Muffalo";
}
...
public class SpecialThingFilterWorker_RawMeat : SpecialThingFilterWorker
{
    ...
    public override bool Matches(Thing t) => t is Corpse corpse && corpse.InnerPawn.def.race.meatDef is ThingDef meat && meat.defName == "Meat_Elephant";
}
