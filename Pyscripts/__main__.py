...
class Test_Tab(Frame):
    ...
    def update(self, *args):
        ...
        for i in range(len(self.dirs)):
            ...
            row += 1
        Button(self.Bottom_Buttons, text="Output Selected", command=lambda: print([f for f in self.dirs if self.data_vars[self.dirs.index(f)].get()]), name="output").place(relx=0.5, rely=0.5, anchor=CENTER)
        ...
        print(self.Checkboxes.winfo_geometry())
        print(self.Main_Rect.winfo_geometry())
    ...
    def sort_width(self):
        print(self.DirOptions)
        #width = [f.winfo_reqwidth() for f in self.buttons].sort()[-1]
       # print(width)
...
class MainWindow(Tk):
    def __init__(self):
        ...
        self.Test = Frame(self.notebook, style='Red.TFrame')
        self.Test.pack()
        self.notebook.add(self.Patch_Extract, text="Patch Extractor")
        ...
        self.Test_Tab = Test_Tab(self.Test)
