...
public class Core_SK_Patch : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect inRect)
    {
        ...
        Settings.InfestationPreventionRadius = ls.SliderLabeled($"Deep Infestation Radius : {Settings.InfestationPreventionRadius.ToString("F2")}", Settings.InfestationPreventionRadius, 10f, 75f, tooltip: "If one deep drill has an infestation recently, it will prevent all deep drills in a certain radius from being infested again. This slider lets you change how big that circle is");
        ls.End();
    }
    #region Bulk Recipe
